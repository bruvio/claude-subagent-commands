...
cp "$SCRIPT_DIR/sub-agent-code-documenter.md" "$COMMANDS_DIR/document.md"
...
# Copy merge review command
echo "📁 Copying merge review command..."
cp "$SCRIPT_DIR/merge_review.md" "$COMMANDS_DIR/merge_review.md"
...
echo "3. /document                - Generate intelligent codebase documentation"
echo ""
...
echo ""
echo "📋 Code Review & Analysis Commands:"
echo "===================================="
echo "12. /merge_review            - Generate comprehensive branch comparison documentation"
echo ""
...
echo ""
echo "# Generate comprehensive merge review documentation"
echo "/merge_review beta"
echo "/merge_review main"
echo ""
echo "# Generate intelligent codebase documentation"
echo "/document"
echo "/document /path/to/project --name \"My Project\" --depth deep"
echo ""
